...
namespace RayTracingModel.Model.Objects3D
{
    public class SphereObject3D : IObject3D
    {
        ...
        public Color CalculateColor(IList<ILight> lightsThatHitsSurface, Vector3D positionVector3D, Vector3D rayDirection, Vector3D collisionPositionVector3D)
        {
            return Shader.CalculateColor(lightsThatHitsSurface, CalculateNormVector(positionVector3D), rayDirection, collisionPositionVector3D);
        }
