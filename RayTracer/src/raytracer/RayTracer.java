...
public class RayTracer {
    ...
    public static void main(String[] args) {
        ...
        scene.addVirtualObject(new VirtualObject_Sphere(new Position3d(0,200,-50),40,new ShaderDiffuse(Color.gray),true,0.3));
		scene.addVirtualObject(new VirtualObject_Sphere(new Position3d(0,350,25),40,new ShaderDiffuse(Color.BLUE),true,0.3));
        ...
        scene.addVirtualObject(new VirtualObject_Sphere(new Position3d(-12,250,550),12,new ShaderSpecular(Color.PINK, Color.white, 100),true,0.3));
